        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-[#1E293B] overflow-hidden shadow-xl rounded-2xl border border-gray-700/50 p-8">
                ...
                <form action="{{ route('jurusan.store') }}" method="POST">
                    ...
                    <!-- Input: ID Jurusan -->
                    <div class="mb-6">
                        <label for="id_jurusan" class="block text-slate-300 font-semibold mb-2">Kode Jurusan
                            (ID):</label>
                    ...
                    <!-- Input: Nama Jurusan -->
                    <div class="mb-8">
                        <label for="nama_jurusan" class="block text-slate-300 font-semibold mb-2">Nama Jurusan:</label>
